...
//         From traditional classics to modern flavors, our recipes bring love to every bite.
//       </p>
      ...
      >
        ...
        >
          {images.map((img, index) => (
            <div
              key={index}
              className="w-full h-[400px] flex-shrink-0 p-3"
            >
              <div className="w-full h-full border-4 border-orange-300 rounded-2xl overflow-hidden bg-white shadow-lg transition-transform duration-500 ease-in-out hover:scale-105">
                <img
                  src={img}
                  alt={`slide-${index}`}
