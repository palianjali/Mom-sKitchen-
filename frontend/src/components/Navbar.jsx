  ...
  //   return (
  //     <div className="flex justify-center items-center py-3 px-6 shadow-md rounded-md bg-white  md:mt-6 md:mr-12 md:ml-12 mt-0">
  //       {/* Logo Section */}
  //       <div>
  //         <Link to="/home">
  //           <img
  ...
  return (
    <>
      <div className="w-full relative h-screen">
        {/* Background image */}
        <img src={assets.theam} alt="theme" className="w-full h-full object-cover" />
