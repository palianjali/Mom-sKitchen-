...
const Navbar = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-3 transition-all duration-300 shadow-md ${
    ...
    >
      ...
      {/* Right Section: Profile Icon and Mobile Menu */}
      <div className="flex items-center gap-4">
        ...
        <div
          ...
          onMouseLeave={() => setShowLogout(false)}
        >
          <div className="hover:bg-green-100 p-2 rounded-full cursor-pointer transition duration-300">
            <UserRound
              size={30}
              className="text-gray-700 hover:text-green-600 transition duration-300"
            />
